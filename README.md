...
-config config file path {option}  
...
-config resource/config.json -client -log resource/log_20221201.json -time '2022-09-05 03:14:40' '2022-09-05 03:15:00  
-config resource/config.json -client -log resource/log_20221201.json -name execute -tail 10  
-config resource/config.json -client -log resource/log_20221201.json -tag tag1 -head 10  
-config resource/config.json -client -log resource/log_20221201.json  
